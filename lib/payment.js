...
var Payment = /** @class */ (function () {
    ...
    Payment.prototype.createPixPaymentRequestWithTX = function (pixKey, amount, uid, message) {
        return __awaiter(this, void 0, void 0, function () {
            var savingsAccountId, createPaymentRequestInput, moneyRequestData;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, this._context.http.graphql(GqlOperations.MUTATION_CREATE_PIX_MONEY_REQUEST, { createPaymentRequestInput: createPaymentRequestInput })];
                    case 2:
                        moneyRequestData = (_a.sent()).data;
                        return [2 /*return*/, moneyRequestData === null || moneyRequestData === void 0 ? void 0 : moneyRequestData.createPaymentRequest];
                }
            });
        });
    };
